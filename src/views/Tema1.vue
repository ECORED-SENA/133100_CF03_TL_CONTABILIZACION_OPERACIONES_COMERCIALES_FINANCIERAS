...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-5 Las transacciones comerciales deben reconocerse monetariamente para generar una serie de documentos contables, no contables y títulos de valores (Angulo, 2018). Por tanto, se profundizará en cada uno de ellos con el fin de lograr un aprendizaje significativo y continuar con el proceso contable de una empresa. Los documentos que se manejan en una entidad son los siguientes:
    ...
    p.mb-5 Tienen una utilidad previa a la transacción comercial. Permiten al comprador tener una idea sobre un acto mercantil, son meramente informativos y no suscita un registro en la contabilidad (Angulo, 2018). Son ejemplos de documentos no contables los siguientes:
    ...
    p.mb-5 En la clasificación de títulos valores se encuentran:

    .row.mb-5
      .col-lg-8
        TabsA.color-acento-contenido.mb-5
          .tarjeta.color-acento-botones--borde.p-5(titulo="Títulos valores a la orden")
          ...
          .tarjeta.color-acento-botones--borde.p-5(titulo="Títulos al portador")
          ...
          .tarjeta.color-acento-botones--borde.p-5(titulo="Títulos valores nominativos")
    ...
    .bg-full-width.bg-color-2
      .px-4.px-md-5.pb-md-3
        ...
        p.mb-5 Según lo determina el Estatuto Tributario, los requerimientos exigidos para la factura son (Secretaría del Senado, 2020. Art. 617):
    ...
    p.mb-5 Para la figura de facturación electrónica debe considerarse el Estatuto Tributario (Secretaría del Senado, 2020. Art. 617) y el Decreto 2242 (Sistema Único de Información Normativa, 2020):
    ...
    p.mb-4.mb-lg-5 La factura equivalente o documentos equivalentes a la factura de venta son (Angulo, 2018):

    .row.mb-5.justify-content-center(data-aos="zoom-in")
      .col-lg-3.pe-lg-0.d-none.d-lg-block
        figure
          img(src="@/assets/curso/tema1/17b.png")
      .col-lg-7.ps-lg-0
          ...
          ol.lista-ol--cuadro
            ...
            li.bg-color-white.p-1.d-flex
              .lista-ol--cuadro__vineta
                span d
              | 
              p.mb-0 Recibos de pagos de matrículas y pensiones emitidas por establecimientos de educación reconocidos por el gobierno.
    ...
    p.mb-5 Es un documento similar a la factura, no es obligatorio, pero se debe tener como soporte. Algunos ejemplos se encuentran en empresas inscritas al régimen simple que no tienen obligación de facturar:

    .row.align-items-center.mb-5
      .col-xl-4(data-aos="fade-right")
        figure.d-none.d-xl-block
          img(src='@/assets/curso/tema1/18.png', alt='' style="max-width: 350px").m-auto
      .col-xl-8(data-aos="fade-left")
        SlyderF(columnas="col-lg-6 col-xl-6")
          .tarjeta.color-acento-botones.p-4
            ...
            p.mb-0 Comerciantes minoristas, siempre y cuando no excedan los topes de venta. Algunos ejemplos son: los comerciantes de productos del agro sin transformación y cuya cuantía no supere los niveles permitidos.
          .tarjeta.color-acento-botones.p-4
            .row.justify-content-center.mb-3
              .col-8
                img(src='@/assets/curso/tema1/20.svg' style="max-width: 90px").m-auto
            p.mb-0.text-center Personas naturales con vínculos laborales.
          .tarjeta.color-acento-botones.p-4
            .row.justify-content-center.mb-3
              .col-8
                img(src='@/assets/curso/tema1/21.svg' style="max-width: 90px").m-auto
            p.mb-0.text-center Las empresas de servicio público de transporte urbano de pasajeros.
          .tarjeta.color-acento-botones.p-4
            .row.justify-content-center.mb-3
              .col-8
                img(src='@/assets/curso/tema1/22.svg' style="max-width: 90px").m-auto
            p.mb-0.text-center Tiquetes de transporte de pasajero de forma aérea.
      
    h3.bg-color-4.tarjeta.p-3.mb-5(data-aos="fade-right") Requisitos del documento equivalente

    p.mb-5 Son todos aquellos inmersos en la resolución de la Dirección de Impuestos y Aduanas Nacionales DIAN 000042 del 2020 en el artículo 13.
    ...
    .row.mb-5
      ...
      .col-lg-7.order-1.mb-3.mb-lg-0
        p.mb-3 Cuando se reconocen las compras, se registra con un débito en las compras al contado, se reconoce la cuenta de impuestos al valor agregado IVA, debitando y aplicando la tarifa vigente y disminuyen las cuentas de efectivo (caja o banco).
          ...
          .col-xl-10
            .box___style_1
              .row.align-items-center
                ...
                .col-xl-auto
                  figure
                    img(src="@/assets/curso/tema1/28.svg").m-auto 
    ...
    .bg-full-width.bg-color-21
      .px-4.px-md-5.pb-md-3
        .row.mb-lg-5.align-items-center
          ...
          .col-lg-9.order-1.mb-3.mb-lg-0
            p.mb-3 Es un medio de pago convencional, donde se utiliza la figura de tarjetahabiente, utilizando un datáfono para recibir pagos. Es una forma segura para no manejar efectivo; el banco o entidad financiera cobra a la empresa una comisión por el uso de este medio electrónico. Cuando se realiza la transacción, se debe guardar copia de la transacción y anexar a la venta como soporte.
        
            .row.mb-5.justify-content-center.align-items-center
              .col-lg-4.mb-3.mb-lg-0
                figure
                  img(src="@/assets/curso/tema1/29.png", data-aos="zoom-in", style="max-width: 295px").mx-auto
              .col-lg-8.bg-color-3-1.p-5.tarjeta(data-aos="fade-left")
                h5.mb-4 Características
                p.ajuste___color.mb-3 Debe definir la ciudad y el nombre del establecimiento comercial, fecha y plazos de pagos, es decir, el número de cuotas para ser pagadas por él cuentahabiente, si es tarjeta de crédito. Si es cuenta de ahorro, la transacción descuenta de forma automática y por medio de correo electrónico se notifica al cliente; comúnmente, el reporte es enviado al dispositivo móvil del cliente por parte de la entidad financiera.
        ...
        p.mb-5 Es un soporte contable en el cual la empresa respalda el pago de empleados por concepto de sueldos a los colaboradores de la empresa de forma mensual, quincenal, cada diez días o, como se haya pactado, el pago de sueldos.
        .row.mb-5.justify-content-center.align-items-center
          .col-lg-4.mb-3.mb-lg-0
            figure
    ...
    p.mb-5 Cada vez que se efectúan compras y ventas de productos o bienes gravados, es obligación de las empresas descontar valores cuantificables, acorde con la base gravable y tarifas aplicadas, descontadas y transferidas a la administración de impuestos y aduanas nacionales DIAN, en las fechas establecidas en el calendario tributario actualizado de cada año fiscal.

    .box___style_2.mb-5(data-aos="zoom-in")
      .row.align-items-center
        .col-xl-auto
          figure
            img(src='@/assets/curso/tema1/33.png', alt='').m-auto
        .col-xl
          h5.fit___p_box.mb-4 Características
          p.fit___p_box Es un medio de confrontación de los pagos efectuados al gobierno nacional, distrital o municipal por concepto de tributos. Son ejemplos de soportes los pagos por concepto de las declaraciones de:
          .row
            .col-lg-4.mb-3.mb-lg-0.d-none.d-lg-block
              figure
            ...
            .col-lg-8.mb-3.mb-lg-0
              ...
              p.fit___p_box.mb-3 Para mayor profundización en el tema se sugiere revisar el siguiente enlace web:
    ...
    p.mb-5 Es una forma de agilizar negocios entre las entidades financieras y/o clientes. Actualmente se utilizan con mayor frecuencia, teniendo en cuenta que se realiza desde un dispositivo móvil con acceso a internet, que genera garantía y seguridad en el momento de realizar la transacción fiscal.
    ...
    .color___box-1
      .px-5
        ...
        .row.mb-3.justify-content-center.align-items-center
          ...
          .col-lg-7.bg-color-10.cambiar-color-1(data-aos="fade-left")
            h5.mb-4 Características
            ul.lista-ul--color
              li.mb-0.d-flex
                i.fas.fa-chevron-right.bg-color-17
        ...
        .row.mb-5.justify-content-center.align-items-center
          ...
          .col-lg-7.bg-color-12.cambiar-color-2.p-4(data-aos="fade-left")
        ...
        .row.mb-5.justify-content-center
          ...
          .col-lg-7.order-1.mb-3.mb-lg-0
            ...
            .bg-color-27-1.p-4.tarjeta(data-aos="fade-left")
              h5.mb-4 Características
    ...
    p.mb-5 Las empresas necesitan realizar pagos mínimos, acorde con los montos establecidos y registrados en las políticas contables y en la resolución interna, llamada gastos de caja menor. Allí se establecen los numerales de pago, los montos y la persona responsable del manejo de dicho fondo.
    ...
    p.mb-5 También denominadas notas internas, utilizadas para enmendar errores o realizar ajustes contables. Se utiliza en aquellas operaciones que carecen de un soporte específico.
    ...
    .bg-full-width.bg-color-21
      .px-4.px-md-5.pb-md-3
        ...
        p.mb-5 Representa la base en la elaboración de estados financieros; como resultado, debe presentar sumas iguales en los débitos y créditos de una transacción comercial.

        .row.mb-5.align-items-center
          .col-lg-4.mb-3.mb-lg-0.order-lg-2
            figure
              img(src="@/assets/curso/tema1/52.png", data-aos="zoom-in",).mx-auto
          .col-lg-8.order-lg-1
            AcordionA(tipo="a" clase-tarjeta="tarjeta acordeonA")
              div(titulo=" Características").ajuste-cajaAcordion
                p.mb-3 Presentan un consecutivo para vincular con las operaciones comerciales de forma cronológica.
                ul.fa-ul.mb-3
                  li.mb-1
                    span.fa-li
                  ...
                  li.mb-0
                    span.fa-li
                      i.fas.fa-chevron-right
                    | Registro contable.
              div(titulo="Son ejemplos de comprobantes de contabilidad").ajuste-cajaAcordion
                ul.fa-ul.mb-3
                  li.mb-1
                    span.fa-li
                      i.fas.fa-chevron-right
              ...
              div(titulo="En el diligenciamiento se debe").ajuste-cajaAcordion
                ul.fa-ul.mb-3
                  li.mb-1
                    span.fa-li
                      i.fas.fa-chevron-right
    ...
    .row.mb-5.align-items-center
      .col-lg-4.mb-3.mb-lg-0.d-none.d-lg-block
        figure
          img(src="@/assets/curso/tema1/54.png", data-aos="zoom-in").m-auto
      .col-lg-8
        p El Código del Comercio establece (Secretaría del Senado, 2020. Art. 621):
        ...
        p.mb-0 Si no se menciona la fecha y el lugar de creación del título, se tendrán como tales la fecha y el lugar de su entrega.
    
    h3.bg-color-4.tarjeta.p-3.mb-5(data-aos="fade-right") Características

    p.mb-5 Según el Código del Comercio (Secretaría del Senado, 2020. Art. 622):

    .row.mb-5.align-items-center
      .col-lg-auto.mb-3.mb-lg-0
        figure
          img(src="@/assets/curso/tema1/55.png", data-aos="zoom-in").mx-auto
      .col-lg
    ...
    h3.bg-color-4.tarjeta.p-3.mb-5(data-aos="fade-right") Clases

    p.mb-5 Según el Código de Comercio, se encuentran títulos: nominativos, a la orden y al portador.
    ...
    p.mb-5 Clases de títulos valores más utilizados:

    h3.bg-color-4.tarjeta.p-3.mb-5(data-aos="fade-right") Letra de cambio
    ...
    .row.mb-5
      ...
      .col-lg-7
        p Requisitos:
        p.mb-0 Según el Código de Comercio (Secretaría del Senado, 2020, Art. 621):
        p Además de lo dispuesto para cada título-valor en particular, los títulos-valores deberán llenar los requisitos siguientes:
        .row.mb-3
          .col-lg-7
    ...
    .row.justify-content-center
      .col-lg-10
        div.bg-color-26-1.tarjeta(data-aos="zoom-in")
          .row.mb-5.justify-content-center.align-items-center.p-4
            .col-lg-5.order-2.d-none.d-lg-block
              figure
                img(src="@/assets/curso/tema1/60.png").m-auto
            .col-lg-7.order-1.mb-3.mb-lg-0
    ...
    h3.bg-color-4.tarjeta.p-3.mb-5(data-aos="fade-right") Pagaré a la orden

    p.mb-5 Es una promesa de pago, es un documento crediticio que respalda una unidad económica en una fecha determinada y, con un interés adicional.
    ...
    .row.mb-5
      ...
      .col-lg-7
        p <b>Requisitos:</b> (Secretaría del Senado, 2020. Art. 709):
    ...
    h3.bg-color-4.tarjeta.p-3.mb-5(data-aos="fade-right") Cheque

    p.mb-5 Un título valor de carácter crediticio respalda unidades monetarias, mediante el uso de una entidad financiera.
    ...
    h3.bg-color-4.tarjeta.p-3.mb-5(data-aos="fade-right") Factura cambiaria

    p.mb-5 (Secretaría del Senado, 2020): Registra las ventas de mercancías que pueden ser al contado o a plazos.

    
    TabsA.color-acento-contenido.mb-5(data-aos="zoom-in")
      .tarjeta.color-acento-botones--borde-1.p-4(titulo="Artículo 772")
        h4 Artículo 772
      ...
      .tarjeta.color-acento-botones--borde-1.p-4(titulo="Artículo 773")
        h4 Artículo 773
    ...
    h3.bg-color-4.tarjeta.p-3.mb-5(data-aos="fade-right") Bonos

    p.mb-5 Títulos valores que representan inversiones en emisiones realizadas por el Estado para financiarse, son inversiones de carácter público.
    ...
    TabsA.color-acento-contenido.mb-5(data-aos="zoom-in")
      .tarjeta.color-acento-botones--borde-1.p-4(titulo="Parágrafo 1º")
        h4 Parágrafo 1º
      ...
      .tarjeta.color-acento-botones--borde-1.p-4(titulo="Parágrafo 2º")
        h4 Parágrafo 2º
      ...
      .tarjeta.color-acento-botones--borde-1.p-4(titulo="Parágrafo 3º")
        h4 Parágrafo 3º
